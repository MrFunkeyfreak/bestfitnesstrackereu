...
class UsersAdministrationViewTablet extends StatefulWidget {
  UsersAdministrationViewTablet({Key key}) : super(key: key);
  @override
  _UsersAdministrationViewTabletState createState() => _UsersAdministrationViewTabletState();
}

class _UsersAdministrationViewTabletState extends State<UsersAdministrationViewTablet> {
