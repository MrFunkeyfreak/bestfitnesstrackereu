...
Route<dynamic> generateRoute(RouteSettings settings) {
  ...
  switch (routingData.route) {
    ...
    case AuthenticationPageRoute:
      return _getPageRoute(const LayoutTemplate(child1: AuthenticationPage()), settings);
...
/*class _getPageRoute extends StatelessWidget {
  final Widget child;      //Widget child for returning the widget/view/page
  final String routeName;
  const _getPageRoute({Key key, @required this.child, @required this.routeName}) : super(key: key);
